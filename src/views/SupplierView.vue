  ...
  <div class="app-container">
    <el-card class="main-card" shadow="never">
      <template #header>
        <div class="card-header">
          <div class="header-left">
            ...
            <span class="title-text">供应商管理 (UC002)</span>
          </div>
          <el-button type="primary" @click="openDialog()">
            <el-icon style="margin-right: 5px"><Plus /></el-icon> 新增供应商
          </el-button>
        </div>
      </template>
      ...
      >
        ...
        <el-table-column prop="bank_account" label="银行账户" width="180" show-overflow-tooltip />
        <el-table-column prop="default_credit_period" label="默认账期(天)" width="110" align="center">
            <template #default="scope">
                <el-tag v-if="scope.row.default_credit_period > 0" type="warning" size="small">{{ scope.row.default_credit_period }} 天</el-tag>
    ...
    <el-dialog v-model="visible" :title="form.id ? '修改供应商' : '新增供应商'" width="600px" align-center>
      <el-form :model="form" label-width="100px">
        <el-row :gutter="20">
            <el-col :span="12">
                <el-form-item label="名称">
                    <el-input v-model="form.name" placeholder="供应商全称" prefix-icon="Shop" />
                </el-form-item>
            </el-col>
            <el-col :span="12">
        ...
        <el-row :gutter="20">
            <el-col :span="12">
                <el-form-item label="联系人">
                    <el-input v-model="form.contact" placeholder="姓名" prefix-icon="User" />
                </el-form-item>
            </el-col>
            <el-col :span="12">
        ...
        <el-form-item label="银行账户">
            <el-input v-model="form.bank_account" placeholder="开户行及账号" prefix-icon="CreditCard" />
        </el-form-item>

        <el-form-item label="地址">
            <el-input v-model="form.address" placeholder="公司详细地址" prefix-icon="Location" />
        </el-form-item>
...
import { Plus, Edit, Delete, Shop, User, Phone, Location, CreditCard } from '@element-plus/icons-vue'
...
const handleSubmit = async () => {
    ...
    if (form.value.id) {
        await axios.put('/api/supplier', form.value)
...
const handleDelete = (row) => {
    ElMessageBox.confirm(`确定要删除供应商【${row.name}】吗？`, '删除确认', {
        ...
        await axios.delete(`/api/supplier?id=${row.id}`)
